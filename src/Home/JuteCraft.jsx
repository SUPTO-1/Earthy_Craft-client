...
const JuteCraft = ({craft}) => {
    ...
    return (
      ...
      <div className="p-8">
        ...
        <p className="text-sm md:text-xl text-[#3A4256] font-poppins font-medium mb-6">{description}</p>
        <div className="flex justify-between mb-10">
          ...
          <h2 className="text-lg md:text-2xl text-[#3A4256] font-lato font-bold">
            {" "}
            {rating} <FaStar className="-mt-2 inline text-lg md:text-2xl text-[#3A4256]" />
          </h2>
        </div>
